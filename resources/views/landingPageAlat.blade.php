    ...
    <body>
                    ...
                    <div class="row align-items-stretch section-overlap">
                        ...
                        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                            <div class="banner-wrap h-100">
                                <a href="/alat" class="h-100">
                                    <h5>Daftar <br> Alat</h5>
                                    <p>
                                        Amet sit amet dolor
                                        <strong>Lorem, ipsum dolor sit amet consectetur adipisicing.</strong>
                                    </p>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                            <div class="banner-wrap bg-warning h-100">
                                <a href="/disposable" class="h-100">
                                    <h5>Daftar <br> Disposable</h5>
                                    <p>
                                        Amet sit amet dolor
                                        <strong>Lorem, ipsum dolor sit amet consectetur adipisicing.</strong>
                                    </p>
                ...
                <div class="row align-center">
                    <div class="col-12 text-center">
                        <ul class="pagination justify-content-center">
                            ...
                            @else
                                <li class="page-item">
                                    <a class="page-link" href="{{ $alat->previousPageUrl() }}"
                                        aria-label="Previous">
                            ...
                            @for ($i = 1; $i <= $alat->lastPage(); $i++)
                                <li class="page-item {{ $i === $alat->currentPage() ? "active" : "" }}">
                                    <a class="page-link" href="{{ $alat->url($i) }}">{{ $i }}</a>
                                </li>
                            @endfor

                            @if ($alat->hasMorePages())
                                <li class="page-item">
                                    <a class="page-link" href="{{ $alat->nextPageUrl() }}" aria-label="Next">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <p class="description text-dark">{{ $asset->description ?? "Deskripsi" }}
                                            </p>
                                            <p class="price">
                                                @if ($stock)
                                                    Stok Tersedia: {{ $stock->current_stock }}
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                const alat = @json($alat); // Data aset
                ...
                searchForm.addEventListener("submit", function(event) {
                    ...
                    const filteredalat = alat.filter(asset => asset.name.toLowerCase().includes(
                        searchTerm));

                    displaySearchResults(filteredalat);
                });
